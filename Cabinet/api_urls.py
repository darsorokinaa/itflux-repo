...
urlpatterns = [
    ...
    path("files/folders/tree/", files_api.FilesFolderTreeView.as_view(), name="cabinet_files_folder_tree"),
    ...
    path("files/folders/<uuid:folder_id>/copy/", files_api.FolderCopyView.as_view(), name="cabinet_files_folder_copy"),
    ...
    path("files/bulk-trash/", files_api.FilesBulkTrashView.as_view(), name="cabinet_files_bulk_trash"),
    path("files/bulk-copy/", files_api.FilesBulkCopyView.as_view(), name="cabinet_files_bulk_copy"),
    path("files/copy-to-students/", files_api.FilesCopyToStudentsView.as_view(), name="cabinet_files_copy_to_students"),
    ...
    path("student/files/folders/tree/", files_api.StudentFilesFolderTreeView.as_view(), name="student_files_folder_tree"),
    ...
    path("student/files/move/", files_api.StudentFilesMoveBatchView.as_view(), name="student_files_move"),
    path("student/files/bulk-trash/", files_api.StudentFilesBulkTrashView.as_view(), name="student_files_bulk_trash"),
