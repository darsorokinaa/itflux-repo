...
const cases = [
  ...
  [
    "𝑦 ={𝑥2⁢ −10⁢𝑥+25𝑥−2припри𝑥≥4,𝑥<4.",
    "y = \\begin{cases}x^{2} - 10x + 25, & \\text{при } x \\ge 4 \\\\ x - 2, & \\text{при } x \\lt 4\\end{cases}",
  ],
  [
    "𝑦 ={𝑥2⁢ −6⁢𝑥+10𝑥+2припри𝑥≥1,𝑥<1.",
    "y = \\begin{cases}x^{2} - 6x + 10, & \\text{при } x \\ge 1 \\\\ x + 2, & \\text{при } x \\lt 1\\end{cases}",
  ],
];
