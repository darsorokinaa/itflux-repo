...
export default function MaterialDemoWarningModal({
  ...
  return createPortal(
    ...
    >
      ...
      >
        <h2 id="material-demo-warning-title">Открыть урок</h2>
        <p>
          После запуска у вас будет <strong>{durationMinutes} минут</strong>, чтобы открыть
          материал и провести занятие.
        </p>
        <p>
        ...
        <p>Материалы доступны только внутри платформы. Скачивание файлов в ознакомительном режиме недоступно.</p>
        <p className="material-demo-warning__emphasis">
          Копирование, сохранение и распространение материалов запрещено.
        </p>
        <div className="material-demo-warning__actions">
          ...
          <button
            ...
            disabled={submitting}
          >
            {submitting ? "Открываем…" : `Открыть на ${durationMinutes} минут`}
          </button>
        </div>
      </div>
    </div>,
