...
const GUIDE_STEPS = [
  ...
  {
    id: "video-lesson",
    title: "Как провести видеоурок",
    icon: "video",
    description: "Видеоурок запускается из карточки занятия: ученики подключаются по ссылке, а материалы можно показывать прямо во время звонка.",
    checklist: [
      "Откройте занятие в «Календаре» или «Уроках».",
      "Нажмите «Начать урок» — откроется видеокомната.",
      "Покажите материалы урока ученикам и завершите занятие, когда оно закончится.",
    ],
    links: [
      { label: "Открыть календарь", to: "/cabinet/schedule" },
  ...
  {
    id: "boards",
    title: "Как пользоваться интерактивными досками",
    icon: "board",
    description: "Доски нужны для совместной работы на уроке: рисование, схемы, заметки и материалы в одном пространстве.",
    checklist: [
      "Откройте «Интерактивные доски».",
      "Нажмите «Создать доску» и при необходимости привяжите её к ученику или группе.",
      "Рисуйте и сохраняйте — изменения пишутся автоматически, доску можно открыть снова в любой момент.",
    ],
    links: [
      { label: "Открыть «Интерактивные доски»", to: "/cabinet/boards" },
    ],
  },
  {
    id: "task-bank",
  ...
  },
  {
    ...
    icon: "note",
    description: "В журнале фиксируются посещаемость, оценки и итоги урока по ученику или группе.",
    checklist: [
      "Откройте «Журнал» и выберите ученика или группу.",
      "Заполните итоги урока: посещаемость, оценки и комментарий.",
      "Опубликуйте итоги — ученик увидит результат, а вы сможете вернуться к истории занятий.",
    ],
    links: [
      { label: "Открыть «Журнал»", to: "/cabinet/journal" },
    ],
  },
  {
    id: "payments",
    title: "Как учитывать оплаты",
    icon: "wallet",
    description: "В разделе оплат можно вести баланс учеников, абонементы и историю платежей.",
    checklist: [
      "Откройте «Оплаты» или карточку ученика.",
      "Зафиксируйте оплату или оформите абонемент (пакет занятий).",
      "Следите за балансом, долгами и остатком занятий в сводке.",
    ],
    links: [
      { label: "Открыть «Оплаты»", to: "/cabinet/payments" },
      { label: "Перейти в «Ученики»", to: "/cabinet/students" },
    ],
  },
  {
    ...
    icon: "bell",
    description: "Подключите Telegram, чтобы получать напоминания об уроках, домашках, журнале и оплатах.",
    checklist: [
      "Откройте «Настройки уведомлений».",
      "Нажмите «Подключить Telegram» и подтвердите связку в боте.",
      "Выберите, о чём получать уведомления: занятия, проверка, журнал, оплаты.",
    ],
    links: [
      { label: "Открыть настройки уведомлений", to: "/cabinet/settings/notifications/" },
    ],
  },
];
