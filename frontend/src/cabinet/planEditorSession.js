...
export function mapPlanItemToEditorSession(item) {
  ...
  return {
    ...
    examTask: item.task_number || item.taskNumber || "",
    goal: item.goal || "",
    brief: item.description || "",
    comment: item.teacher_comment || item.teacherComment || "",
    materialsNotes: item.lesson_materials_notes || item.materialsNotes || "",
