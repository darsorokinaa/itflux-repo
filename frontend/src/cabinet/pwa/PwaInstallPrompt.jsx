      ...
      <div className="pwa-prompt__body">
        ...
        {iosHelp ? (
          <p className="pwa-prompt__hint">
            {isIosDevice()
              ? "На iPhone/iPad: «Поделиться» → «На экран „Домой“». Звонки надёжнее открывать в Safari, не из иконки: камера из ярлыка часто не включается."
              : "В меню браузера выберите «Установить приложение» или «Добавить на экран „Домой“». Если звонок не открывается — зайдите через браузер, не из ярлыка."}
          </p>
        ) : null}
      </div>
